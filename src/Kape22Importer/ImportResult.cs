...
// carry the same ConversionError values the rest of the pipeline uses. XmlArchivePath is filled by the
// Epic 3 orchestrator once the normalized XML is written next to the archived Fichier.
