...
// guard found a prior success and skipped the insert, so the double logging emits the "déjà importé,
// ignoré" line rather than reading the structural Success && InsertedId == null shape.
